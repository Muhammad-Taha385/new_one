...
//       tileColor: grey.withAlpha(15),
//       title: Text(
//         user.name,
//         style: TextStyle(fontFamily: "Caros", fontWeight: FontWeight.w600),
//       ),
//       subtitle: Text(
...
//         backgroundColor: grey.withAlpha(20),
//         radius: 25.r,
//         child: Text(
//           user.name.isNotEmpty ? user.name[0] : "?",
//           style: h.copyWith(color: primary, fontSize: 20),
//         ),
//       ),
//       trailing: Column(
...
//           //       SizedBox(
//           //         height: 2.h,
//           //       ), // keeps layout stable if no timestamp
...
class ChattTile extends StatelessWidget {
  final Usermodel user;
  final MessageModel? message;
  final int index;
  final int unreadCount;
            ...
            Column(
              ...
              children: [
                ...
                Text(
                  user.name,
                  style: TextStyle(
                      fontFamily: "Caros", fontWeight: FontWeight.w600),
                ),
                Text(
                  message?.content ?? "No messages yet",
                  overflow: TextOverflow.ellipsis,
