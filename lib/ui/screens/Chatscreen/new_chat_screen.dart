...
//       onRefresh: () async {
//   final contactBloc = context.read<ContactBloc>();
//   // Always reload contacts on pull
//   contactBloc.add(LoadfriendsContacts(widget.currentUid));

//   // Optionally wait a bit to let bloc fetch data
...
//     // Subscribe to Firestore friend updates
//     friendsSubscription = FirebaseFirestore.instance
//         .collection("requests") // your collection
...
//           // Reload contacts in Bloc when friend accepts
//           context
//               .read<ContactBloc>()
//               .add(LoadfriendsContacts(widget.currentUid));
//           break;
...
//     // Initial load
//     context.read<ContactBloc>().add(LoadfriendsContacts(widget.currentUid));
//   }
...
class _NewChatScreenState extends State<NewChatScreen> {
  ...
  void initState() {
    ...
    // Listen for accepted friend requests involving current user
    friendsSubscription = FirebaseFirestore.instance
        .collection("requests")
      ...
      if (snapshot.docs.isNotEmpty) {
        // Notify Bloc to reload contacts
        context.read<ContactBloc>().add(LoadfriendsContacts(widget.currentUid));
      }
    });
